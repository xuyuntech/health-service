...
func (setup *FabricSetup) InitHospital() (string, error) {
	// Prepare arguments
	var args []string
	args = append(args, "initHospital")

	eventID := "initHospital"
...
func (setup *FabricSetup) QueryAllHospital() (string, error) {

	// Prepare arguments
	var args []string
	args = append(args, "queryAllHospital")
